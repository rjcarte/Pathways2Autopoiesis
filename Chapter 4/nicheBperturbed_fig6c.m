...
% NOTES:
%
% Simulation demonstrates a reversible perturbation of Niche B (niche
% B->niche X->niche B)
% 
...
Z = 8e6; % Number of iterations of the simulation
...
E(2,:) = [0 10 n 3e6]; % Perturb niche A at z=1e6 by removing all diffusive transfer
E(3,:) = [phi cMix v 5e6]; % Remove perturbation and set environment back to original settings
