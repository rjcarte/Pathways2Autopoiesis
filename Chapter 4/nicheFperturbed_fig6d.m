...
% NOTES:
%
% Simulation demonstrates reversible perturbation of Niche F
%
...
cMix = 2; % No. of automaton mixed on each time step (diffusive mixing)
...
E(2,:) = [0 cMix v 3e6]; % Perturb niche A at z=1e6 by removing all diffusive transfer
