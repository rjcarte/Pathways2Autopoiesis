...
Z = 5e7; % Number of iterations of the simulation
...
INITTYPE = 1873; % Initial number of automata types in the population. This is FIXED.
histSamplingRate = 50;
popDynamics=zeros(Z/histSamplingRate,1873,'single'); % Population dynamics history
N = INITTYPE * 48; % Population size
